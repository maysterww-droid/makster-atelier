...
function priceMeta(item: { manufacturer: string | null; sku: string | null; parameters_json: unknown }, operationLabels: Record<string,string>, manualPrice: string) {
