...
export function ModuleSchematic({moduleKey,name='',widthMm=600,heightMm=720,className=''}:Props){
  ...
  const stroke='#31443a'; const fill='#f7faf8'; const front='#e8efe9';
  return <svg className={`${styles.root} ${className}`} viewBox="0 0 120 120" role="img" aria-label={name||moduleKey}>
    <polygon points={`${x},${y} ${x+7},${y-6} ${x+bodyW+7},${y-6} ${x+bodyW},${y}`} fill="#eef3ef" stroke={stroke} strokeWidth="1.5"/>
    <polygon points={`${x+bodyW},${y} ${x+bodyW+7},${y-6} ${x+bodyW+7},${y+bodyH-6} ${x+bodyW},${y+bodyH}`} fill="#dfe8e1" stroke={stroke} strokeWidth="1.5"/>
    ...
    {type==='sink'?<><rect x={x+3} y={y+3} width={bodyW-6} height={bodyH-6} fill={front} stroke={stroke} strokeWidth="1"/><ellipse cx={x+bodyW/2} cy={y+7} rx={Math.max(8,bodyW*.22)} ry="3.5" fill="#d7e0dc" stroke={stroke} strokeWidth="1.2"/><line x1={x+bodyW-8} x2={x+bodyW-8} y1={midY-4} y2={midY+4} stroke={stroke} strokeWidth="1.8"/></>:null}
    {type==='oven'?<><rect x={x+3} y={y+3} width={bodyW-6} height={bodyH-6} fill="#eef1ef" stroke={stroke} strokeWidth="1"/><rect x={x+8} y={y+16} width={bodyW-16} height={bodyH-27} rx="2" fill="#34443d"/><rect x={x+11} y={y+22} width={bodyW-22} height={bodyH-39} rx="1" fill="#91a099"/><circle cx={x+bodyW/2-8} cy={y+10} r="1.8" fill={stroke}/><circle cx={x+bodyW/2+8} cy={y+10} r="1.8" fill={stroke}/></>:null}
    {type==='tall-oven'?<><rect x={x+3} y={y+3} width={bodyW-6} height={bodyH-6} fill={front} stroke={stroke} strokeWidth="1"/><line x1={x+3} x2={x+bodyW-3} y1={y+24} y2={y+24} stroke={stroke}/><rect x={x+8} y={y+30} width={bodyW-16} height="34" rx="2" fill="#34443d"/><rect x={x+11} y={y+37} width={bodyW-22} height="20" fill="#91a099"/><line x1={x+3} x2={x+bodyW-3} y1={y+72} y2={y+72} stroke={stroke}/></>:null}
    ...
    {type==='dishwasher'?<><rect x={x+3} y={y+3} width={bodyW-6} height={bodyH-6} fill="#e5ebe7" stroke={stroke}/><rect x={x+7} y={y+8} width={bodyW-14} height="5" rx="1" fill="#8d9a94"/><circle cx={x+bodyW-11} cy={y+10.5} r="1.3" fill={stroke}/></>:null}
