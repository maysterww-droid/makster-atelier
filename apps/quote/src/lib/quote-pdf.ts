...
type LocaleLabels = {
  ...
  net:string; tax:string; total:string; deposit:string; lead:string; payment:string; warranty:string; note:string; supplier:string;
};
...
const extraNames: Record<string,Record<string,string>> = {
  ru: { delivery:'Доставка', installation:'Монтаж', other:'Прочее', worktop:'Столешница', plinth:'Цоколь', filler:'Доборы / фальшпанели', decor:'Декоративные боковины' },
  en: { delivery:'Delivery', installation:'Installation', other:'Other', worktop:'Worktop', plinth:'Plinth', filler:'Fillers / panels', decor:'Decorative side panels' },
  cs: { delivery:'Doprava', installation:'Montáž', other:'Ostatní', worktop:'Pracovní deska', plinth:'Sokl', filler:'Výplně / krycí panely', decor:'Dekorativní bočnice' },
  de: { delivery:'Lieferung', installation:'Montage', other:'Sonstiges', worktop:'Arbeitsplatte', plinth:'Sockel', filler:'Blenden / Passleisten', decor:'Dekorseiten' },
  pl: { delivery:'Dostawa', installation:'Montaż', other:'Inne', worktop:'Blat', plinth:'Cokół', filler:'Blendki / panele wypełniające', decor:'Boki dekoracyjne' },
};
...
export async function buildQuotePdf(snapshot:QuoteSnapshot): Promise<Buffer> {
  ...
  const docDefinition = {
    ...
    content:[
      ...
      {text:'Makster Quote · MQ 0.1.11',style:'small',margin:[0,22,0,0]},
    ],
  };
