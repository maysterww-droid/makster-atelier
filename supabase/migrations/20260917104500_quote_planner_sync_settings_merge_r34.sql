-- R34 hotfix: Planner sync must merge its own settings into the existing Quote project.
-- Manager/commercial fields already stored in projects.settings must survive subsequent Planner UPDATEs.
