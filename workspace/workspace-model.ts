...
export type WorkspaceTab='BRIEF'|'CONCEPT'|'SCRIPT'|'STORYBOARD'|'SHOTS'|'QA'|'APPROVAL'|'EXPORTS';
...
export const WORKSPACE_TABS:readonly WorkspaceTab[]=['BRIEF','CONCEPT','SCRIPT','STORYBOARD','SHOTS','QA','APPROVAL','EXPORTS'];
